...
@media print{.print-note{display:none}.report-section{break-inside:avoid}body{-webkit-print-color-adjust:exact;print-color-adjust:exact}}
    ...
    const metaWrap=el(d,'div','meta'); metaWrap.append(
      ...
      el(d,'div','',new Date().toLocaleString('es-CL')),
      el(d,'div','','Gonzalo Campos V.'),
      el(d,'div','','Constructor Civil · Evaluador CEV'),
      el(d,'div','','Res. Ex. Acreditación 1336/2025')
    );
    ...
    authorBox.append(
      ...
      el(d,'span','','Constructor Civil · Evaluador CEV · Res. Ex. Acreditación 1336/2025')
    );
    body.append(authorBox);
